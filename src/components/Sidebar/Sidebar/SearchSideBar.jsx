...
import FillStar from "../../../assets/SearchPage/FillStar.svg";
import Star from "../../../assets/SearchPage/Star.svg";
    ...
    <div className="bg-white container mx-auto text-[#041E42]">
      ...
      <ul className="ml-4">
        <li className="mb-2 flex items-center cursor-pointer">
          ...
          />
          <span className="gap-1 text-xl flex items-center">
            <img src={FillStar} alt="Filled Star" className="w-4 h-4" />
            <img src={FillStar} alt="Filled Star" className="w-4 h-4" />
            <img src={FillStar} alt="Filled Star" className="w-4 h-4" />
            <img src={FillStar} alt="Filled Star" className="w-4 h-4" />
