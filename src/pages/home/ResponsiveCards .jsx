  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 md:gap-4 ">
        ...
        <div className="grid gap-4">
          <div className="bg-white mb-4">
            <div className="flex flex-col items-center mt-8">
              ...
              <h3 className="text-lg">iPhone 12 Pro</h3>
              <p className="">128GB</p>
      ...
      <div className="col-span-2 md:col-span-2">
        <div className="grid gap-4">
          <div className="bg-[#FFE3D2] flex flex-col md:flex-row items-center md:items-start h-fit">
          ...
          <div className="flex flex-col md:flex-row justify-center md:justify-start">
            <div className="p-4 pb-2 md:pb-0">
              <div className="bg-white  shadow-md overflow-hidden flex flex-col md:flex-row">
      ...
      <div className="col-span-1 md:col-span-1 bg-white">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="relative">
              <img src={table} alt="iPhone 12 Pro" className="object-cover" />
              <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 flex space-x-2">
                <span className="w-2 h-2 bg-white rounded-full"></span>
                <span className="w-2 h-2 bg-gray-300 rounded-full"></span>
                <span className="w-2 h-2 bg-gray-300 rounded-full"></span>
